<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body class="h-[100vh] w-[100vw]">
        <div class="h-[100%] w-[100%] flex justify-between items-center flex-col">
            <!-- ############### HEADER ###################### -->
            <div class="w-[100%]">
            ...
            <div class="flex flex-col justify-center px-6 py-2  lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <!-- <img class="mx-auto h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company"> -->
                    <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 ">Create your
                        account</h2>
                </div>
                ...
                <div class="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" action="signup.do" method="POST">
                        ...
                        <div>
                            ...
                            <div>
                                <input type="text" id="name" name="name" autocomplete="on" required
                                    class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow hover:shadow-2xl ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email"
                                    ...
                                    class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow hover:shadow-2xl ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <p class="hidden mt-1 text-sm text-red-500 dark:text-red-300" id="email_error">Please
                                    enter valid Email Address!!</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="password" name="password" type="password" minlength="8" maxlength="16"
                                    required
                                    class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow hover:shadow-2xl ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <input type="text" id="phone" name="phone" required
                                    class="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow hover:shadow-2xl ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <p class="hidden mt-1 text-sm text-red-500 dark:text-red-300" id="phone_error">Please
          ...
          <input type="text" id="otp" name="otp" required autocomplete="none" class="basis-1/2 mr-4 block w-9/12 rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow hover:shadow-2xl ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6">
                        ...
                        <div class="flex mb-2 space-x-2 rtl:space-x-reverse" id="otp_div">
                            <div>
                                ...
                                <input type="text" maxlength="1" autocomplete="off" name="c1"
                                    onkeyup="focusNextInput(this, 'code1', 'code2')" id="code1"
                            ...
                            <div>
                                ...
                                <input type="text" maxlength="1" name="c2" autocomplete="off"
                                    onkeyup="focusNextInput(this, 'code1', 'code3')" id="code2"
                                    class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div>
                                <label for="code3" class="sr-only">Third code</label>
                                <input type="text" maxlength="1" autocomplete="off" name="c3"
                                    onkeyup="focusNextInput(this, 'code2', 'code4')" id="code3"
                                    class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div>
                                <label for="code4" class="sr-only">Fourth code</label>
                                <input type="text" maxlength="1" autocomplete="off" name="c4"
                                    onkeyup="focusNextInput(this, 'code3', 'code5')" id="code4"
                                    class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div>
                                <label for="code5" class="sr-only">Fivth code</label>
                                <input type="text" maxlength="1" autocomplete="off" name="c5"
                                    onkeyup="focusNextInput(this, 'code4', 'code6')" id="code5"
                                    class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div>
                                <label for="code6" class="sr-only">Sixth code</label>
                                <input type="text" maxlength="1" autocomplete="off" name="c6"
                                    onkeyup="focusNextInput(this, 'code5', 'code6')" id="code6"
                                    class="block w-9 h-9 py-3 text-sm font-extrabold text-center text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            ...
                            <div>
                                <button type="button" id="otpButton"
                                    class=" hidden basis-1/4 h-8 text-white  bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-xs px-5 py-2 text-center me-2 mb-2">Send
                                    OTP</button>
                            </div>

                        </div>
                        <p class="hidden mt-1 text-sm text-red-500 dark:text-red-300" id="otp_error">Please enter valid
                            OTP!!</p>
                        <p class="hidden mt-1 text-sm text-green-700 dark:text-green-700" id="otp_sent_message">OTP Sent
                            To Your Email!</p>
        ...
        <label for="link_checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline">terms and conditions</a>.</label>
                        ...
                        <div>
                            <button type="submit" disabled id="signup_btn"
                                class="flex w-full justify-center rounded-md bg-gradient-to-r from-violet-500 to-fuchsia-500 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-2xl hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign
                                Up</button>
                        </div>
                    </form>
                </div>
